<!-- Hero Section -->
<section class="bg-cover bg-center hero-height relative">
    <div class="container mx-auto hero-height flex items-center text-white pb-[120px] xs:pb-40">
        <div class="hero-content opacity-0 translate-y-10 transition-all duration-1000 ease-out">
            ...
            <p class="text-lg md:text-4xl xs:text-2xl p-2 mt-4 text-web-secondary font-bold">Fast and Reliable Towing &
        ...
        <div class="mt-8 flex flex-col sm:hidden -mx-2 absolute bottom-0 right-0 left-0">
            <!-- Call Now Button -->
            <div
                class="bg-web-secondary flex flex-col h-24 items-center justify-center text-web-primary font-bold py-3 px-8 transition-all duration-300 transform">
        ...
        <!-- Mobile Buttons Section -->
        <div class="xs:hidden absolute bottom-0 h-[120px] left-0 right-0 bg-web-primary z-10 flex">
            <div class="bg-web-secondary w-1/3 h-full flex items-center justify-center">
                <img src="/assets/icons/clock-primary.svg" class="h-10 mr-4">
                <p class="text-3xl bold text-web-primary uppercase">Arrival in no time</p>
            </div>
            <div class="bg-web-primary w-1/3 h-full">
                <a href="tel:+1234567890" class="flex items-center justify-center h-full">
                    <span class="text-5xl font-bold text-web-secondary">+1 234 567 890</span>
                </a>
            </div>
            <div class="bg-web-secondary w-1/3 h-full flex items-center justify-center">
                <img src="/assets/icons/24-hours-primary.svg" class="h-10 mr-4">
                <p class="text-3xl bold text-web-primary uppercase">24/7 On-Demand Towing</p>
            </div>
        </div>
    </div>
</section>
